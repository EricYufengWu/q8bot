...
def main():
    ...
    for joint in JOINTS:
        dxl_addparam_result = groupBulkRead.addParam(joint, ADDR_PRESENT_POSITION, ADDR_BYTE_LEN)
    ...
    while(1):
        ...
        for joint in JOINTS:
            dxl_getdata_result = groupBulkRead.isAvailable(joint, ADDR_PRESENT_POSITION, ADDR_BYTE_LEN)
        ...
        for j in range(len(JOINTS)):
            pos_deg[j] = angle_dxl_to_friendly(groupBulkRead.getData(JOINTS[j], ADDR_PRESENT_POSITION, ADDR_BYTE_LEN))
